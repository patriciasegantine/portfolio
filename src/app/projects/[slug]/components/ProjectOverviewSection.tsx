...
const ProjectOverviewSection = ({ caseStudy }: ProjectOverviewSectionProps) => {
  ...
  return (
    <section className="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800/50 p-6">
      <h2 className="text-xl font-medium text-primary-dark dark:text-zinc-50 mb-3">Project Overview</h2>
      <p className="text-secondary dark:text-zinc-300 leading-relaxed">{caseStudy.projectOverview}</p>
    </section>
  );
};
